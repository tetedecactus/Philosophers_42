...
/*   Updated: 2022/02/16 14:40:14 by olabrecq         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/philo.h"

/*This function is a metaphore, it is where the program begin for real
The theards[number_of_philo] are create and send to routine function*/
void start_diner(t_data *data)
{
	...
	i = 0;
	while (i < n)
	{//envoyer info.philo[i] aulieu de data
